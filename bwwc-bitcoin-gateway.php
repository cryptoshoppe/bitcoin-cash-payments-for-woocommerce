...
https://github.com/cryptoshoppe/bitcoin-cash-payments-for-woocommerce
*/
    ...
    class BWWC_Bitcoin extends WC_Payment_Gateway
    {
        ...
        public function is_gateway_valid_for_use(&$ret_reason_message=null)
        {
            ...
            if (!$this->service_provider) {
                ...
                if (!$mpk) {
                    $reason_message = __("Please specify Electron Cash Master Public Key (MPK) in Bitcoin Cash plugin settings. <br />To retrieve MPK: launch your Electron Cash wallet, select: Wallet->Information", 'woocommerce');
                    $valid = false;
...
<ol class="bpit-instructions">
    <li>' . __('We ONLY accept Bitcoin Cash (BCH). Any oter payments (BTC/BSV) will not process and the money will be lost!', 'woocommerce') . '</li>
    <li>' . __('We are not responsible for lost funds if you send BTC or BSV instead of BCH', 'woocommerce') . '</li>
...
';
        ...
        */
        ...
        public function admin_options()
        {
	    	...
	    	<p>
	    		<?php _e(
                'Allows to accept payments in Bitcoin Cash. <a href="https://bitcoincashers.org/" target="_blank">Bitcoin Cash</a> is peer-to-peer, decentralized digital currency that enables instant payments from anyone to anyone, anywhere in the world',
                        'woocommerce'
            ); ?>
	    	</p>
	    	<?php
