=== (BETA) Bitcoin Cash (BCH) Payments for WooCommerce ===
Contributors: cryptoshoppe, mboyd1, sanchaz, gesman, bitcoinway.com
Tags: bitcoin cash, bitcoin cash wordpress plugin, bitcoin cash plugin, bitcoin cash payments, accept bitcoin cash, bch, bchabc
Requires at least: Wordpress 3.1.1 / WooCommerce  3.5.7
...
* Automatic conversion to Bitcoin Cash via exchange rate feed and calculations.
...
3. Activate.
4. Configure plugin with your local Electron Cash (https://electroncash.org/) master public key
...
* cryptoshoppe: https://github.com/cryptoshoppe/
